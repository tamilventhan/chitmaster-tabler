<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="mb-2">
            ...
            <x-secondary-button class="me-2 btn btn-sm" type="button" x-on:click.prevent="$refs.photo.click()">
                {{ __('Select A New Photo') }}
            </x-secondary-button>

            @if ($this->user->profile_photo_path)
            <x-secondary-button type="button" class="btn btn-sm btn-danger"  wire:click="deleteProfilePhoto">
                {{ __('Remove Photo') }}
            </x-secondary-button>
            @endif
        ...
        <div class="mb-3">
            ...
            <p class="mt-3">
                ...
                <button type="button" class="btn btn-sm btn-primary" wire:click.prevent="sendEmailVerification">
